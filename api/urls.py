...
from .views import MyTokenObtainPairView,UserDetailAPI,RegisterUserAPIView,ChangePasswordView,UpdateProfileView,APILogoutView,LoginView,EmbeddedCreate
...
urlpatterns = [    
    ...
    path('api/embedded/create/',EmbeddedCreate.as_view()),
